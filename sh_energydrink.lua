...
ITEM.model = Model("models/props/cryts_food/drink_energydrink.mdl")
ITEM.description = "An energy drink with russian lettering. Tastes like battery acid, but it gives you a rush."
